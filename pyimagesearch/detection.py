...
def detect_people(frame, net, ln, personIdx=0):
	...
	for output in layerOutputs:
		...
		for detection in output:
			...
			# The first 4 elements represent the center_x, center_y, width and height.
			# The fifth element represents the confidence that the bounding box encloses an object.
			# The rest of the elements are the confidence associated with each class (i.e. object type).
			# The box is assigned to the class corresponding to the highest score for the box.
			scores = detection[5:]
